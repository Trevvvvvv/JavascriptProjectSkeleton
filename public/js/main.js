    ...
    $.ajax({
        ...
        success: function(data){
          for (i=0;i<data.items.length;i++){
            ...
            {
            results.innerHTML += "<span class = 'description' style ='float:right'>Per comprare il libro clicca qui: " + "<a href ='" + data.items[i].saleInfo.buyLink + "'>" + "<button> compra il libro </button>" + "</span>"
            }
          }
